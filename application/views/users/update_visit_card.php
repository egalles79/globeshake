			...
			<form  id="pedo" method="post" action="#">
				<div class="tarjvitr_contres">
					...
					<div class="tarjvitr_linea">
						...
						<div class="tarjvitr_nombredosbi"><input id="tarjvitr_nombredos" type="text" name="tarjvitr_nombredos" placeholder="NOMBRE"></div>
						<div class="tarjvitr_nombreapellidos"><input id="tarjvitr_nombreapellidos" type="text" name="tarjvitr_nombreapellidos" placeholder="APELLIDOS"></div>
						<div class="tarjvitr_lineanombre"></div>
						<div class="tarjvitr_lineanapel"></div>

						<div class="tarjvitr_empleauton"><p class="tarjvitr_eplautdos">¿Empleado?</p><span class="tarjvitr_eplautdos">Si</span><input class="tarjvitr_eplaut" type="radio" name="empleadosi" value="si">
							<span class="tarjvitr_eplautdosspa">No</span>
							<input class="tarjvitr_eplautdos" type="radio" name="empleadono" value="no"></div>

							<div class="tarjvitr_empleautondos">
								<p class="tarjvitr_eplautdos">¿Autónomo?</p><input class="tarjvitr_eplauttres" type="radio" name="autonomosi" value="si"><span class="tarjvitr_eplautdos">Si</span>
							...
							<div class="tarjvitr_linefunci"></div>
							<div class="tarjvitr_pais"><select>
						...
						<div class="tarjvitr_email"><input id="tarjvitr_email" type="text" name="tarjvitr_email" placeholder="EMAIL"></div>
